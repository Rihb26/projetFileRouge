package io.bootify.credit_offre_habitat.envoie_dedemande.domain;
...
@Entity
@Table(name = "EnvoieDedemandes")
@EntityListeners(AuditingEntityListener.class)
@Getter
@Setter
public class EnvoieDedemande {
    ...
    @OneToMany(mappedBy = "envoieDedemande")
