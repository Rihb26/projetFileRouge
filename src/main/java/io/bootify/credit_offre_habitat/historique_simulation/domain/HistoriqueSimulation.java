package io.bootify.credit_offre_habitat.historique_simulation.domain;
...
@Entity
@Table(name = "HistoriqueSimulations")
@EntityListeners(AuditingEntityListener.class)
@Getter
@Setter
public class HistoriqueSimulation {
    ...
    @OneToMany(mappedBy = "historiqueSimulation")
